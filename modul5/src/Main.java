...
public class Main {
    ...
    static void printSelectHeroMenu() {
        ...
        System.out.println("6. Display all Hero");
        System.out.println("0. Exit");
        System.out.print("Select your hero: ");
    }

    static void printActionMenu(int noCharacter) {
        System.out.println("\n=== ACTION ===");
        System.out.println("Active Hero: " + hero.get(noCharacter).getName());
        ...
        try {
            ...
            switch (option) {
                case 1:
                    ...
                    int mana = in.nextInt();
                    in.nextLine();
                    hero.add(new Mage(name, age, heroGender, "Mage", mana));
                ...
                case 2:
                    ...
                    in.nextLine();
                    hero.add(new Fighter(name, age, heroGender, "Fighter", spellVamp));
                    System.out.println(">> Fighter added successfully!");
                    break;
                case 3:
                    System.out.print("Cooldown skill: ");
                    int cooldownSkill = in.nextInt();
                    in.nextLine();
                    hero.add(new Assassin(name, age, heroGender, "Assassin", cooldownSkill));
                ...
                case 4:
                    ...
                    in.nextLine();
                    hero.add(new Marksman(name, age, heroGender, "Marksman", attackSpeed));
    ...
    static void actionMenu(int noCharacter) {
        int action;
        do {
            printActionMenu(noCharacter);
            action = in.nextInt();
            in.nextLine();
            ...
            switch (action) {
                ...
                case 1:
                    System.out.println("\n--- HERO INFO ---");
                    hero.get(noCharacter).displayClassInfo();
                    break;
                case 2:
                    System.out.println("\n--- ATTACK ---");
                    hero.get(noCharacter).attack();
                    break;
                case 3:
                    System.out.println("\n--- ULTIMATE ---");
                    hero.get(noCharacter).useUltimate();
                    break;
                default:
        ...
        do {
            ...
            switch (option) {
                ...
                case 5:
                    inputHeroes(option);
                    if (!hero.isEmpty()) {
                        int lastIndex = hero.size() - 1;
                        actionMenu(lastIndex);
                    }
                    break;
                case 6:
                    if (hero.isEmpty()) {
                        ...
                        for (Character c : hero) {
                            System.out.println("=== NAME " + c.getName() + " ===");
                            System.out.println("Hero age    : " + c.getAge());
                            System.out.println("Hero gender : " + c.getGender());
                            System.out.println("Hero role   : " + c.getRole());
                        }
                        break;
                    }
                default:
